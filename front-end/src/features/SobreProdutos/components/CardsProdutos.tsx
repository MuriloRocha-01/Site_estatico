 ...
 const {goToProdutoEspecifico} = useMenu();
  ...
  return (
    <div className="relative px-0 md:px-10 mx-4 md:mx-20 pt-15 pb-20 md:pb-0">
      ...
      className="absolute left-20 md:left-6 lg:left-8 md:bottom-auto bottom-5 md:top-1/2 md:-translate-y-1/2 
      ...
      <button
        ...
        className="absolute right-20 md:right-6 lg:right-8 md:bottom-auto bottom-5 md:top-1/2 md:-translate-y-1/2 text-white p-3 md:p-2 rounded-full md:w-10 w-11 0 flex items-center justify-center hover:scale-105 transition-all duration-300 ease-in-out bg-red"
      >
