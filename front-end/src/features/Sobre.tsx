...
function Sobre(){
    return(
        <section className='relative'>
            ...
            <section className='min-h-[110vh] lg:min-h-[92vh] md:h-full pl-4 pt-[80px] xl:pt-[20px] text-center gap-14 md:gap-[5%] pb-12 md:pb-0 justify-center w-full flex items-center bg-gray-300'>
                ...
                <div className="text-[1rem] text-gray-600 leading-relaxed space-y-4 text-justify">
            ...
            <section className='py-16 px-6 md:px-32 xl:px-[15%] bg-gray-100 text-black'>
